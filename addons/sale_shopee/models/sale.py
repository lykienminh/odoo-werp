...
class SaleOrderShopeeInherit(models.Model):
    _inherit = 'sale.order'
    _description = 'Sale Order Shopee Inherit'
    ...
    sp_buyer_fulladdress = fields.Char()
...
class ShopeeShippingDocument(models.Model):
    ...
    _description = 'Shopee Shipping Document'
...
class ShopeeSelectableShippingDoc(models.Model):
    ...
    _description = 'Shopee Selectable Shipping Document'
...
class ShopeeShippingItem(models.Model):
    ...
    _description = 'Shopee Shipping Item'
