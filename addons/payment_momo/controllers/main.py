...
class MoMoController(http.Controller):
    _return_url = '/payment/momo/dpn/'
    _notify_url = '/payment/momo/ipn/'

    @http.route('/payment/momo/create', type='http', methods=['POST'], auth="public", csrf=False)
