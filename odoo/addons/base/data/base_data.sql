...
-- Default data
---------------------------------
insert into res_currency (id, name, symbol) VALUES (1, 'USE', 'đ');
...
insert into res_partner (id, name, company_id, create_date) VALUES (1, 'My Partner', 1, now() at time zone 'UTC');
